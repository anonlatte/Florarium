...
import com.anonlatte.florarium.databinding.ListItemPlantFullBinding
...
class PlantsFullAdapter : RecyclerView.Adapter<PlantsFullAdapter.PlantsViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PlantsViewHolder {
        ...
        val binding = ListItemPlantFullBinding.inflate(inflater, parent, false)
        binding.root.setOnClickListener {
            findNavController(binding.root).navigate(
                R.id.action_plantsListFragment_to_creationFragment,
                bundleOf(
    ...
    inner class PlantsViewHolder(private val binding: ListItemPlantFullBinding) :
